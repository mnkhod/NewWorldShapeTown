...
import {
    ...
    checkGiftFromNatureAchievement,
    checkFirstFishAchievement,
} from "../utility";
...
export default class TutorialScene extends Phaser.Scene {
    ...
    editorCreate() {
        ...
        tutorialMap.createLayer(
            "Map environment/Background[Just Render]",
            ["GroundTileset"],
            -768,
            -416
        );
        ...
        const map_environment_Ground_just_render__1 = tutorialMap.createLayer(
            "Map environment/Ground[just render]",
            ["RoadStone"],
            -767,
            -416
        );
        ...
        tutorialMap.createLayer(
            "Map environment/Road[Just render]",
            ["RoadStone"],
            -768,
            -416
        );
        ...
        // layerFence
        const layerFence = tutorialMap.createLayer(
            "Map environment/Fence[Make it collision]",
            ["RoadStone"],
            -768,
            -416
        );
        ...
        const farmingAreaFarmingTile = tutorialMap.createLayer(
            "Farming Area/FarmingTile[Use SEED to grow crops]",
            ["RoadStone"],
            -768,
            -416
        );
        ...
        const layerFishingPondBorder = tutorialMap.createLayer(
            "FishingPond/FishingPondBOrder[Make it Collision]",
        ...
        tutorialMap.createLayer(
            "FishingPond/FishingPondWater[Anywhere can be fishing action start]",
            ["GroundTileset", "LakeAccessor", "Fishes_3_32x32"],
            -768,
            -416
        );
        ...
        tutorialMap.createLayer(
            "FishingPond/FishingPondAccessor[]just render]",
            ["LakeAccessor", "LakeFloatingRock_V02", "LakeFloatingRock_V01"],
            -768,
            -416
        );

        // layerTreeBorder1
        const layerTreeBorder1 = tutorialMap.createLayer(
            "Treeborder[Make it Collision]/TreeBorder",
            ["TreePatteren"],
            -768,
            -416
        );
        ...
        // layerTreeBorder
        const layerTreeBorder = tutorialMap.createLayer(
            "Treeborder[Make it Collision]/TreeBorder1",
            ["TreePatteren"],
            -768,
            -416
        );
        ...
        // layerTreeBorder2
        const layerTreeBorder2 = tutorialMap.createLayer(
            "Treeborder[Make it Collision]/TreeBorder2",
            ["TreePatteren"],
            -768,
            -416
        );
        ...
        // layerHouseGround
        const layerHouseGround = tutorialMap.createLayer(
            "House/HouseGround",
            ["GroundTileset"],
            -768,
            -416
        ...
        // layerPine
        const layerPine = tutorialMap.createLayer(
            "Tree/PineTree",
            ["Apple"],
            -768,
            -416
        ...
        const farming_Area_Crops_Make_it_Collision_popup_to_not_able_to_HARVET__1 =
            tutorialMap.createLayer(
                "Farming Area/Crops[Make it Collision/popup to not able to HARVET]",
                ["FarmingCropsVer2"],
                -768,
                -416
            );
        ...
        const farming_Area_DeadCrops_Make_it_Collision_Can_be_HARVEST_but_noting_drops__1 =
            tutorialMap.createLayer(
                "Farming Area/DeadCrops[Make it Collision/Can be HARVEST but noting drops]",
                ["FarmingCropsVer2"],
                -768,
                -416
            );
        ...
        // itemHudPrefab
        const itemHudPrefab = new ItemHudPrefab(
            this,
            17.999990057997366,
            714.0380149603411
        );
        ...
        // messagePrefab
        const messagePrefab = new MessagePrefab(
            this,
            0.706304947792546,
            0.8045771466410088
        );
        ...
        // alertPrefab
        const alertPrefab = new AlertPrefab(
            this,
            721.70328457044,
            0.0215605880291605
        );
        ...
        const fishingComponentPrefab = new FishingComponentPrefab(
            this,
            64,
            640
        );
        ...
        this.map_environment_Ground_just_render__1 =
            map_environment_Ground_just_render__1;
        ...
        this.farming_Area_Crops_Make_it_Collision_popup_to_not_able_to_HARVET__1 =
            farming_Area_Crops_Make_it_Collision_popup_to_not_able_to_HARVET__1;
        this.farming_Area_DeadCrops_Make_it_Collision_Can_be_HARVEST_but_noting_drops__1 =
            farming_Area_DeadCrops_Make_it_Collision_Can_be_HARVEST_but_noting_drops__1;
    ...
    create() {
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.layerFishingPondWaterForFishing
        );
    ...
    async setupSceneAchievementNftsData() {
        this.achievements.firstHarvestAchievement =
            await checkFirstHarvestAchievement();
        this.achievements.giftFromNatureAchievement =
            await checkGiftFromNatureAchievement();
        this.achievements.firstFishAchievement =
            await checkFirstFishAchievement();
